...
def classifier_train_with_constraint(mode=None):
    ...
    weights_save_dir = "./ckpt/classifier-resnet101-100c-constrainted-by-" + weights_dir_dict[mode] + "/" + "classifier-resnet101-100c-constrainted-by-" + weights_dir_dict[mode]
    
    res101.load_weights("./ckpt/classifier-resnet101-100c-20-retrain/classifier-resnet101-100c-20-retrain")
...
def classifier_train_without_constraint():
    ...
    # param block
    # first 20 eps block all resnet101's layers(only train classfier head),final 20 eps train all trainable layers
    ...
    weights_save_dir = "./ckpt/classifier-resnet101-100c-20-retrain/classifier-resnet101-100c-20-retrain"
...
def metrics_test():
    ...
    weights_save_dir = "./ckpt/classifier-resnet101-100c-40-retrain/classifier-resnet101-100c-40-retrain"
    # weights_save_dir = "./ckpt/classifier-resnet101-100c-constrainted-by-labelmask/classifier-resnet101-100c-constrainted-by-labelmask"
    # weights_save_dir = "./ckpt/classifier-resnet101-100c-constrainted-by-instancemask/classifier-resnet101-100c-constrainted-by-instancemask"
    # weights_save_dir = "./ckpt/classifier-resnet101-100c-constrainted-by-componentmask/classifier-resnet101-100c-constrainted-by-componentmask"
    # weights_save_dir = "./ckpt/classifier-resnet101-100c-constrainted-by-knowledge-inject/classifier-resnet101-100c-constrainted-by-knowledge-inject"
    ...
    res_dir = './result/resnet101-baseline'
