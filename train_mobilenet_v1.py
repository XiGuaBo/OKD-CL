...
def classifier_train_with_constraint(mode = None):
    ...
    weights_save_dir = "./ckpt/classifier-mobilenet_v1-99-constrainted-by-" + weights_dir_dict[mode] + "/" + "classifier-mobilenet_v1-99-constrainted-by-" + weights_dir_dict[mode]
    
    v1.load_weights("./ckpt/classifier-mobilenet_v1-99-40-retrain/classifier-mobilenet_v1-99-40-retrain")
    global_loss = UNLIMIT
...
def classifier_train_without_constraint():
    ...
    # param block
    # first 20 eps block all mobilenetv1's layers(only train classfier head),sec 10 eps block only mobilenetv1's pre-55 layers,final 10 eps train all trainable layers
    ...
    weights_save_dir = "./ckpt/classifier-mobilenet_v1-99-20-retrain/classifier-mobilenet_v1-99-20-retrain"

    # weights_save_dir = "./ckpt/classifier-mobilenet_v1-99-30-retrain/classifier-mobilenet_v1-99-30-retrain"
    # v1.load_weights("./ckpt/classifier-mobilenet_v1-99-20-retrain/classifier-mobilenet_v1-99-20-retrain")

    # weights_save_dir = "./ckpt/classifier-mobilenet_v1-99-40-retrain/classifier-mobilenet_v1-99-40-retrain"
    # v1.load_weights("./ckpt/classifier-mobilenet_v1-99-30-retrain/classifier-mobilenet_v1-99-30-retrain")
...
def metrics_test():
    ...
    weights_save_dir = "./ckpt/classifier-mobilenet_v1-99-60-retrain/classifier-mobilenet_v1-99-60-retrain"
    # weights_save_dir = "./ckpt/classifier-mobilenet_v1-99-constrainted-by-labelmask/classifier-mobilenet_v1-99-constrainted-by-labelmask"
    # weights_save_dir = "./ckpt/classifier-mobilenet_v1-99-constrainted-by-instancemask/classifier-mobilenet_v1-99-constrainted-by-instancemask"
    # weights_save_dir = "./ckpt/classifier-mobilenet_v1-99-constrainted-by-componentmask/classifier-mobilenet_v1-99-constrainted-by-componentmask"
    # weights_save_dir = "./ckpt/classifier-mobilenet_v1-99-constrainted-by-knowledge-inject/classifier-mobilenet_v1-99-constrainted-by-knowledge-inject"
    ...
    res_dir = './result/mobilenet_v1-baseline-60'
...
def main():
    ...
    # first 40 epochs: first 20 eps block all mobilenetv1's layers(only train classfier head),sec 10 eps block only mobilenetv1's pre-xx layers,final 10 eps train all trainable layers
