...
def classifier_train_with_constraint(mode = None):
    ...
    weights_save_dir = "./ckpt/classifier-mobilenet_v2-100c-constrainted-by-" + weights_dir_dict[mode] + "/" + "classifier-mobilenet_v2-100c-constrainted-by-" + weights_dir_dict[mode]
    
    v2.load_weights("./ckpt/classifier-mobilenet_v2-100c-20-retrain/classifier-mobilenet_v2-100c-20-retrain")
    global_loss = UNLIMIT
...
def classifier_train_without_constraint():
    ...
    # param block
    # first 20 eps block all mobilenetv2's layers(only train classfier head),final 20 eps train all trainable layers
    ...
    weights_save_dir = "./ckpt/classifier-mobilenet_v2-100c-20-retrain/classifier-mobilenet_v2-100c-20-retrain"
...
def metrics_test():
    ...
    weights_save_dir = "./ckpt/classifier-mobilenet_v2-100c-40-retrain/classifier-mobilenet_v2-100c-40-retrain"
    # weights_save_dir = "./ckpt/classifier-mobilenet_v2-100c-constrainted-by-labelmask/classifier-mobilenet_v2-100c-constrainted-by-labelmask"
    # weights_save_dir = "./ckpt/classifier-mobilenet_v2-100c-constrainted-by-instancemask/classifier-mobilenet_v2-100c-constrainted-by-instancemask"
    # weights_save_dir = "./ckpt/classifier-mobilenet_v2-100c-constrainted-by-componentmask/classifier-mobilenet_v2-100c-constrainted-by-componentmask"
    # weights_save_dir = "./ckpt/classifier-mobilenet_v2-100c-constrainted-by-knowledge-inject/classifier-mobilenet_v2-100c-constrainted-by-knowledge-inject"
    ...
    res_dir = './result/mobilenet_v2-baseline'
