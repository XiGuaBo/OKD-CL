...
def classifier_train_with_constraint(mode = None):
    ...
    weights_save_dir = "./ckpt/classifier-vgg-99-constrainted-by-" + weights_dir_dict[mode] + "/" + "classifier-vgg-99-constrainted-by-" + weights_dir_dict[mode]
    
    vgg.load_weights("./ckpt/classifier-vgg-99-40-retrain/classifier-vgg-99-40-retrain")
...
def classifier_train_without_constraint():
    ...
    # param block
    # first 20 eps block all vgg's layers(only train classfier head),sec 10 eps block only vgg's pre-10 layers,final 10 eps train all trainable layers
    
    # for example,first 20 eps will be like the following
    for idx,layer in enumerate(vgg.layers):
        if ('vgg16' in layer.name):
            for layer_ in layer.layers[:10]:
    ...
    weights_save_dir = "./ckpt/classifier-vgg-99-20-retrain/classifier-vgg-99-20-retrain"

    # weights_save_dir = "./ckpt/classifier-vgg-99-30-retrain/classifier-vgg-99-30-retrain"
    # vgg.load_weights("./ckpt/classifier-vgg-99-20-retrain/classifier-vgg-99-20-retrain")

    # weights_save_dir = "./ckpt/classifier-vgg-99-40-retrain/classifier-vgg-99-40-retrain"
    # vgg.load_weights("./ckpt/classifier-vgg-99-30-retrain/classifier-vgg-99-30-retrain")
...
def metrics_test():
    ...
    weights_save_dir = "./ckpt/classifier-vgg-99-60-retrain/classifier-vgg-99-60-retrain"
    # weights_save_dir = "./ckpt/classifier-vgg-99-constrainted-by-labelmask/classifier-vgg-99-constrainted-by-labelmask"
    # weights_save_dir = "./ckpt/classifier-vgg-99-constrainted-by-instancemask/classifier-vgg-99-constrainted-by-instancemask"
    # weights_save_dir = "./ckpt/classifier-vgg-99-constrainted-by-componentmask/classifier-vgg-99-constrainted-by-componentmask"
    # weights_save_dir = "./ckpt/classifier-vgg-99-constrainted-by-knowledge-inject/classifier-vgg-99-constrainted-by-knowledge-inject"
    ...
    res_dir = './result/vgg-baseline-60'
    # res_dir = './result/vgg-labelmask'
    # res_dir = './result/vgg-instancemask'
    # res_dir = './result/vgg-componentmask'
    # res_dir = './result/vgg-knowledge-inject'
    # res_dir = './result/vgg-labelmask-union'
    # res_dir = './result/vgg-instancemask-union'
    # res_dir = './result/vgg-componentmask-union'
...
def main():
    ...
    # first 40 epochs: first 20 eps block all vgg's layers(only train classfier head),sec 10 eps block only vgg's pre-xx layers,final 10 eps train all trainable layers
