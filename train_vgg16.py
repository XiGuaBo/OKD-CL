...
def classifier_train_with_constraint(mode = None):
    ...
    weights_save_dir = "./ckpt/classifier-vgg-100c-constrainted-by-" + weights_dir_dict[mode] + "/" + "classifier-vgg-100c-constrainted-by-" + weights_dir_dict[mode]
    
    vgg.load_weights("./ckpt/classifier-vgg-100c-20-retrain/classifier-vgg-100c-20-retrain")
...
def classifier_train_without_constraint():
    ...
    # param block
    # first 20 eps block all vgg's layers(only train classfier head),final 20 eps train all trainable layers
    ...
    weights_save_dir = "./ckpt/classifier-vgg-100c-20-retrain/classifier-vgg-100c-20-retrain"
...
def metrics_test():
    ...
    weights_save_dir = "./ckpt/classifier-vgg-100c-40-retrain/classifier-vgg-100c-40-retrain"
    # weights_save_dir = "./ckpt/classifier-vgg-100c-constrainted-by-labelmask/classifier-vgg-100c-constrainted-by-labelmask"
    # weights_save_dir = "./ckpt/classifier-vgg-100c-constrainted-by-instancemask/classifier-vgg-100c-constrainted-by-instancemask"
    # weights_save_dir = "./ckpt/classifier-vgg-100c-constrainted-by-componentmask/classifier-vgg-100c-constrainted-by-componentmask"
    # weights_save_dir = "./ckpt/classifier-vgg-100c-constrainted-by-knowledge-inject/classifier-vgg-100c-constrainted-by-knowledge-inject"
...
def main():
    ...
    classifier_train_with_constraint(mode = "KI_HC")
