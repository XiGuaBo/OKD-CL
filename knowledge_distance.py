...
# res50.load_weights("./ckpt/classifier-resnet50-99-60-retrain/classifier-resnet50-99-60-retrain")

# res101 = ResNet_101(feature_out=True,vector_out=True,dim_out=classNums)
# res101.load_weights("./ckpt/classifier-resnet101-99-60-retrain/classifier-resnet101-99-60-retrain")
