...
class DataLoader:
# @param # ['Hard_masks','Instance-level_soft_masks','Component-level_soft_masks']
    def __init__(self,data_root,lab_type=lab_type):
        ...
        # ../train/001/1-0.png
        # ../lab_type/1-0.png
        self.lab_files = [ lab.replace(data_root.split('/')[-1]+'/'+lab.split('/')[-2],lab_type).replace('tr-cg','lb-cg') for lab in self.img_files ]
        # self.lab_files.sort()
