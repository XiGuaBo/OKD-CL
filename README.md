...
The dataset should contain directories for train,test,hard_masks,instance-level_masks and component-level masks. (The knowledge vectors had been restored in code source as 99 .txt files of the knowledge dictory). Train and test dictory both have 99 sub-dictories including 99 object categories' image instances and dictories of masks also have the same sub-dictories formed including corresponding pixel-level annotation. 
